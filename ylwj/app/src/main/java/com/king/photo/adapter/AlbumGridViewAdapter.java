...
public class AlbumGridViewAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.iv_choose = (ImageView) convertView
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
		...
		viewHolder.toggleButton.setOnClickListener(new ToggleClickListener(viewHolder.iv_choose));
		return convertView;
	}
	...
	private class ToggleClickListener implements OnClickListener{
		ImageView iv_choose;
		public ToggleClickListener(ImageView iv_choose){
			this.iv_choose = iv_choose;
		}
		...
		public void onClick(View view) {
			if (view instanceof ToggleButton) {
				...
				if (dataList != null && mOnItemClickListener != null
					...
					mOnItemClickListener.onItemClick(toggleButton, position, toggleButton.isChecked(), iv_choose);
				}
			}
		}
	}
	...
	public interface OnItemClickListener {
		public void onItemClick(ToggleButton view, int position,
								boolean isChecked, ImageView iv_choose);
	}
