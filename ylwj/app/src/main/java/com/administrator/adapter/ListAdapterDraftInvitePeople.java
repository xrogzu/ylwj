 ...
 */
public class ListAdapterDraftInvitePeople extends BaseAdapter {

    private List<BigstageUser.DataEntity> mData;

    private DraftInvitePeopleActivity mActivity;
    ...
    public static class MyHandler extends Handler {
        private WeakReference<ListAdapterDraftInvitePeople> mListAdapter;

        public MyHandler(ListAdapterDraftInvitePeople people) {
            mListAdapter = new WeakReference<ListAdapterDraftInvitePeople>(people);
        }

        @Override
        public void handleMessage(Message msg) {
            ListAdapterDraftInvitePeople listAdapter = mListAdapter.get();
            if (listAdapter != null) {
...
//                            Toast.makeText(listAdapter.mActivity, object.get("message").toString(), Toast.LENGTH_SHORT).show();
    ...
    public ListAdapterDraftInvitePeople(DraftInvitePeopleActivity activity, BaseApplication application) {
        mActivity = activity;
        mData = new ArrayList<>();
