...
import com.administrator.fragment.MyCreditPay_HistoryFragment;
 ...
 * 我的积分消费
 */
public class MyCreditPayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTotalWidth = MyCreditPayActivity.this.getWindowManager().getDefaultDisplay().getWidth();//获取屏幕宽度
    ...
    private void initFragments() {
        ...
        MyCreditPay_HistoryFragment fragment1 = new MyCreditPay_HistoryFragment(MyCreditPayActivity.this, Constant.WAIT_PAY);
        fragment1.setNeedShowProgressDialog(true);
        mFragments.add(fragment1);//待付款

        MyCreditPay_HistoryFragment fragment2 = new MyCreditPay_HistoryFragment(MyCreditPayActivity.this, Constant.PATED);
        mFragments.add(fragment2);//已付款

        MyCreditPay_HistoryFragment fragment3 = new MyCreditPay_HistoryFragment(MyCreditPayActivity.this, Constant.ALL_PAY);
    ...
    private void initViews() {
        ...
        tv_title.setText("我的积分消费");
        tv_title.setTextColor(ContextCompat.getColor(this, R.color.black));


        ib_back.setOnClickListener(MyCreditPayActivity.this);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrollStateChanged(int state) {
                if(state == 2) {
                    ...
                    maginLeft(position);
                    ((MyCreditPay_HistoryFragment) mFragments.get(position)).update();
                    ((MyCreditPay_HistoryFragment) mFragments.get(position)).showProgressDialog();
                }
            }
        });
    ...
    private void showPopScreen() {//筛选弹窗
        ...
        tv_popsrceen1.setOnClickListener(MyCreditPayActivity.this);
        tv_popsrceen2.setOnClickListener(MyCreditPayActivity.this);
        tv_popsrceen3.setOnClickListener(MyCreditPayActivity.this);
        tv_popsrceen4.setOnClickListener(MyCreditPayActivity.this);
...
//        popupWindow.showAtLocation(MyCreditPayActivity.this.findViewById(R.id.linear_shoplist),
//                Gravity.TOP, 0, li_drop.getHeight() + statusBarHeight + radioGroup.getHeight());
    ...
    private void showPopWindow() {
        ...
        tv_favoral.setOnClickListener(new View.OnClickListener() {//优惠活动
            @Override
            public void onClick(View v) {
                Intent intent0 = new Intent(MyCreditPayActivity.this, Interalshop_shopactivity.class);
        ...
        tv_integral.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(MyCreditPayActivity.this, Interalshop_interalactivity.class);
        ...
        tv_shop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(MyCreditPayActivity.this, Interalshop_shopactivity.class);
