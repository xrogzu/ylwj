...
public class ShareUtil2 {
    ...
    public ShareUtil2(Activity activity) {
     ...
     * @param url 点击分享跳转的链接
     */
    public void openShare(final View popWindowParentView, final Activity context, final String content, final String imageURL, boolean hasNearBy, final SocializeListeners.OnSnsPlatformClickListener listener,String url) {
