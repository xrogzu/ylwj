...
public class AlbumHelper {
	...
	void buildImagesBucketList() {
		...
		if (cur != null && cur.moveToFirst()) {
			...
			int addDateIndex = cur.getColumnIndexOrThrow(Media.DATE_ADDED);
			...
			do {
				...
				String date = cur.getString(addDateIndex);

				Log.i(TAG, _id + ", bucketId: " + bucketId + ", picasaId: "
						+ picasaId + " name:" + name + " path:" + path
						+ " title: " + title + " size: " + size + " bucket: "
						+ bucketName + " date:" + date + "---");
		...
		cur = cr.query(Media.INTERNAL_CONTENT_URI, columns, null, null,
				null);
		if (cur != null && cur.moveToFirst()) {
			int photoIDIndex = cur.getColumnIndexOrThrow(Media._ID);
			int photoPathIndex = cur.getColumnIndexOrThrow(Media.DATA);
